...
Проверката валидира JSON файловете, JavaScript синтаксиса в `index.html` и потвърждава, че `.env` и `node_modules` не са в папката за публикуване. GitHub Actions изпълнява същата проверка при push.
